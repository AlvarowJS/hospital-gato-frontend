    ...
    return (
        ...
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Log in to MediCare</h2>
            </div>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p href="#" className="text-center font-semibold text-indigo-600 hover:text-indigo-500">Sign up</p>
            </div>
        </div>
